...
export const LOTTERY_ABI = [
  ...
  "event DrawSettled(uint64 indexed drawTimestamp, uint8[6] winningNumbers, uint256 jackpot, uint256 winnerCount, uint256 prizePerWinner)",
  ...
  "event TicketMinted(address indexed buyer, uint256 indexed ticketId, uint64 indexed drawTimestamp, uint8[6] numbers)",
  ...
  "function draws(uint64) view returns (uint256 jackpotTotal, uint256 winnerCount, uint256 prizePerWinner, uint8[6] winningNumbers, bool settled, uint256 remainingJackpot)",
  "function getJackpot() view returns (uint256)",
  "function getJackpotForDraw(uint64 drawTimestamp) view returns (uint256)",
  "function getTicketsByOwner(address user) view returns (tuple(uint256 id, address owner, uint8[6] numbers, uint64 drawTimestamp, bool claimed)[])",
  "function isWinningTicket(uint256 ticketId) view returns (bool)",
  "function jackpotBps() view returns (uint16)",
  "function mintTicket(uint8[6] calldata numbers, uint64 drawTimestamp) payable",
  ...
  "function settleAndRollover(uint64 drawTimestamp, uint8[6] calldata winningNumbers) nonpayable",
  "function settleDraw(uint64 drawTimestamp, uint8[6] calldata winningNumbers, uint256 winnerCount) nonpayable",
  "function ticketPrice() view returns (uint256)",
  "function tickets(uint256) view returns (uint256 id, address owner, uint8[6] numbers, uint64 drawTimestamp, bool claimed)",
