              ...
              <div className="p-12 space-y-8 bg-gray-50/50 dark:bg-[#021411]/50">
                <section className="bg-white dark:bg-[#04211C] p-8 rounded-[2rem] border border-emerald-100 dark:border-emerald-500/10 shadow-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="p-6 rounded-xl bg-gray-50 dark:bg-emerald-500/5">
                      <span className="text-[10px] font-black uppercase tracking-widest text-emerald-800/40 block mb-2">{t.available}</span>
                      <div className="text-2xl font-black dark:text-white">{referralBalance.available.toFixed(2)} M-USDT</div>
                    </div>
                    <div className="flex flex-col gap-3">
                      <PrimaryButton onClick={copyRefLink}>{t.copyLink}</PrimaryButton>
                    </div>
                  </div>
                </section>
              </div>
